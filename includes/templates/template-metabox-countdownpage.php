...
<?php $cntdwnp_timershow_yn_value = get_post_meta($post->ID, '_wswebinar_cntdwnp_timershow_yn', true); ?>
            <input type="checkbox" data-switch="true" name="cntdwnp_timershow_yn" id="cntdwnp_timershow_yn" value="yes" <?php echo ($cntdwnp_timershow_yn_value == "yes" ) ? 'checked="checked"' : ''; ?> >
            <div class="webinar_clear_fix"></div>
        </div>
    </div>
</div>
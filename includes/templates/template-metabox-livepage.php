...
<div id="livep-accordian" class="ws-accordian">
    ...
    <div class="ws-accordian-section">
        ...
        <div class="form-field">
            ...
            <p class="description livep_vidurl_desc livep_vidurl_for_youtube" style="<?php echo (empty($livep_vidurl_type) || $livep_vidurl_type == 'youtube') ? '' : 'display:none'; ?>"><?php _e('Paste Youtube/Hangouts URL here (Eg: https://www.youtube.com/watch?v=3TkgTEfx9XM OR http://youtu.be/CqlB2SiG-ac)', WebinarSysteem::$lang_slug); ?></p>
        ...
        <div class="form-group">
            ...
            <input type="checkbox" data-switch="true" name="livep_video_auto_play_yn" id="livep_video_auto_play_yn" value="yes" <?php echo ($livep_video_auto_play_yn_value == "yes" ) ? 'checked="checked"' : ''; ?> >

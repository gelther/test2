...
<div id="livep-accordian" class="ws-accordian">
    ...
    <div class="ws-accordian-section">
        ...
        <!-- <div class="form-group">
            ...
            <input type="checkbox" data-switch="true" name="replayp_yn" id="replayp_yn" value="yes" <?php echo ($replayp_yn_value == 'yes' ) ? 'checked="checked"' : ''; ?> >
            <div class="webinar_clear_fix"></div>
        </div> -->
        ...
        <div class="form-field">
            ...
            <p class="description replayp_vidurl_desc replayp_vidurl_for_youtube" style="<?php echo (empty( $replayp_vidurl_type ) || $replayp_vidurl_type == 'youtube') ? '' : 'display:none'; ?>"><?php _e( 'Paste Youtube URL here (Eg: https://www.youtube.com/watch?v=3TkgTEfx9XM OR http://youtu.be/CqlB2SiG-ac)', WebinarSysteem::$lang_slug ); ?></p>
            <p class="description replayp_vidurl_desc replayp_vidurl_for_vimeo" style="<?php echo (empty( $replayp_vidurl_type ) || $replayp_vidurl_type == 'vimeo') ? '' : 'display:none'; ?>"><?php _e( 'Paste Vimeo video ID here (Eg: 129673042))', WebinarSysteem::$lang_slug ); ?></p>
        ...
        <div class="form-group">
            ...
            <input type="checkbox" data-switch="true" name="replayp_video_auto_play_yn" id="replayp_video_auto_play_yn" value="yes" <?php echo ($replayp_video_auto_play_yn_value == 'yes' ) ? 'checked="checked"' : ''; ?> >

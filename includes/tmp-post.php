                                ...
                                <?php if (empty($data_imgvid_url)) { ?>
                                    ...
                                    switch ($data_imgvid_type):
                                        ...
                                        case 'youtube':
                                            ...
                                            if ($youtubeid !== false) {
                                                echo '<iframe width="100%" height="315" src="//youtube.com/embed/' . $youtubeid . '?controls=0&rel=0&showinfo=0' . $autoplay . '" frameborder="0" allowfullscreen></iframe>';
                                            } elseif (!empty($link)) {
                                                echo '<iframe width="100%" height="315" src="//youtube.com/embed/' . $link . '?controls=0" frameborder="0&rel=0&showinfo=0' . $autoplay . '" allowfullscreen></iframe>';
                                            }
                                            break;
                                        case 'vimeo':
                                            echo '<iframe src="https://player.vimeo.com/video/' . $data_imgvid_url . '' . $autoplay . '" width="100%" height="563" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
                                            break;
                                    endswitch;
                                }
                                ?>
                            ...
                            <div class="ticket-bottom" style="background-color: #fbd35d;">
                                <div class="ticket-bottom" style="background-color: <?php echo $the_tnxp_ticket_body_background_color ?>;">
                                    <div style="color: <?php echo $the_tnxp_ticket_text_color ?>; padding: 25px;">
                                        ...
                                        <div class="ticket-info"><span class="glyphicon glyphicon-time"></span>&nbsp;&nbsp;<span class="tick-left"><?php _e('Time', WebinarSysteem::$lang_slug) ?></span><span class="tick-right"><?php echo date_i18n($timeFormat, $attend_time) .' '.$timeZone; ?></span></div>
                                    </div>
